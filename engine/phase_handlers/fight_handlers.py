...
def fight_phase_start(game_state: Dict[str, Any]) -> Dict[str, Any]:  # noqa: F811 (V11 override of V10)
    ...
    players_present = {int(require_key(entry, "player")) for entry in game_state["units_cache"].values()}
    for _fp in players_present:
        build_enemy_adjacent_hexes(game_state, _fp)

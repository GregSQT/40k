...
> |---|---|---|
> | `obs_size` | **20 712** (2026-07-28, V11 §9.3 P2 — bloc « contexte de décision ») | `ObservationBuilder.SQUAD_OBS_SIZE_TARGET`, **calculé** depuis le schéma d'entités (`engine/observation_entities.py`) ; porté par `config/agents/<agent>/<agent>_training_config.json` → `observation_params` |
> | espace d'action | **1 068** (1 047 micro + 15 macro + **6 `CHOICE_i`**, V11 §9.3 P2) | `engine/macro_intents.py` (`TOTAL_ACTION_SIZE`), miroir de `shared_utils.SQUAD_ACTION_*` |
>
...
>   (20 slots ennemis)**, 1045 charge, 1046 fight, 1047-1061 zone intents, **1062-1067 `CHOICE_i`**

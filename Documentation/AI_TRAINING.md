...
```json
{
  ...
  "default": {
    ...
    "observation_params": {
      // SEULE clé de la section : recopie de ObservationBuilder.SQUAD_OBS_SIZE_TARGET (14609 au

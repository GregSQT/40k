# Migration vers units_cache comme source unique (version 21 - mort = absent)
...
### OK statique (ne pas utiliser runtime)
...
- `build_units_cache` (OK init, pas runtime)

...
| ~~~10 règles observées non appliquées~~ | ✅ **SOLDÉ** — il n'en reste **aucune** | Les 9 règles listées au 2026-07-24 sont traitées : TORRENT, TWIN_LINKED, SUSTAINED_HITS, LETHAL_HITS, MELTA, ANTI_* ✅ ; EXTRA_ATTACKS ✅ ; PSYCHIC ✅. **INDIRECT_FIRE (24.19) était la seule restante ; son chantier a été LIVRÉ le 2026-08-17, 7 pièces** (`Implémenté/indirect_fire_10_07.md`). Ce n'est pas une règle de résolution mais un TYPE DE TIR entier (10.07), donc un chantier à part et non un portage — ce qui s'est confirmé : il a fallu faire du type de tir une DÉCISION (10.02), donc changer l'espace d'action. 2 armes concernées, aucune dans les rosters de training. ⚠️ Dépendance déjà notée : quand elle sera faite, son couvert devra passer par un point qu'[IGNORES COVER] 24.18 annule aussi. | — |

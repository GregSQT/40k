...
[`../Implémenté/bug_squad_fight_mask_mismatch.md`](../Implémenté/bug_squad_fight_mask_mismatch.md)
...
- [`../1_Agent/V11_phaseA.md`](../1_Agent/V11_phaseA.md) §9.4 pt 5 — P3-5, dont ce doc est le
  prérequis.
- [`../1_Agent/V11_agent_rework.md`](../1_Agent/V11_agent_rework.md) — la dette « le gym n'emprunte

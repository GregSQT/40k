...
- ✅ **Livraison 2026-08-12 — trois verrous de test, aucun changement de comportement moteur.**
  ...
  passent en chemin complet. Les 395 modules de `tests/` s'importent (2 `importorskip`
  préexistants mis à part). ⚠️ **La vérification large reste à passer par l'utilisateur** : c'est
  elle, et elle seule, qui couvre les 251 fichiers moteur non relancés ici.

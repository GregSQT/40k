...
aboutir. (L'ancienne dépendance §0.12 → §0.14 est **levée depuis le 2026-07-20**, §0.12 étant
livré.) Les statuts ont été confrontés au code, à `git status` et à **deux runs réels** le
2026-07-20.

...
Ce n'est pas théorique : `terrain-mc1.json` et `terrain-train-01.json` ont des `walls` au digest
**identique** (vérifié — ils ne diffèrent que par `floors`), et de nouveaux terrains arrivent.

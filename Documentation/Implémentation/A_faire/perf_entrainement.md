...
| 2.4 | **Mesure de clôture** : non-régression env ✅ (bench_env_step 3×, médiane 29–31 ms, plage Phase 1) ; durée d'update SB3 (train/time_update TensorBoard) à lire au prochain run réel | — | 🟡 (env OK, update à mesurer run réel) |
...
| 2026-08-26 | **Mesure 2.4 — Phase 2 complète (2.1–2.3)**, `bench_env_step.py` 600 steps, machine au repos, 3 répétitions | wall total · médiane · P95 · P99 | **77,2 / 75,8 / 72,5 s · 31,2 / 30,3 / 29,2 ms · 703 / 688 / 676 ms · 1551 / 1455 / 1455 ms** — médiane dans la plage Phase 1 (24–31 ms), aucune régression côté env. **Note** : bench_env_step mesure UN seul env (workers), pas le learner. Les gains 2.1–2.3 (GPU buffer ×1/rollout, ~225 syncs éliminés, RPC ×341→×1 masks) sont dans le pipeline SB3 et se mesurent sur `train/time_update` TensorBoard lors du prochain run réel. |

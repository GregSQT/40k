...
| 4.3 | **Mesure de clôture** : durée gate ; calibrage du nombre de tranches ; consigner §6 — parité confirmée (8-ép §6 + tests unitaires) ; **durée propre TBD** (script dans `worktree-mesure-gate-43`) | — | 🟡 |

...
| `deadly_demise` | `Unit N DEADLY DEMISE Roll:D → Unit M(c,r) SUFFERS X MW [DEADLY DEMISE]` (d6≥6) ou `… → no effect [DEADLY DEMISE]` (d6<6) — une entrée par unité dans le rayon 6" | compteur `deadly_demise_triggers` + `note_rule_usage("24.08")` — **COUVERT (2026-08-25)** |

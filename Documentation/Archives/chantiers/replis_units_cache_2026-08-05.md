...
> [`../replis_unit_by_id_2026-08-05.md`](replis_unit_by_id_2026-08-05.md).
...
**Après enquête.** Le doute levé en §8 est tranché : elle est morte, pas orpheline
   ...
   **Résidus traités avec elle** : le libellé `FIGHT_CONSOLIDATION_PLAN` de
   ...
   d'appel affirmée par [`Documentation/Archives/chantiers/pile_in_overrun_par_figurine_2026-08-18.md`](Documentation/Archives/chantiers/pile_in_overrun_par_figurine_2026-08-18.md) §6

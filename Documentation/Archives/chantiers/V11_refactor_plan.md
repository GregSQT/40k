...
> [`Documentation/Archives/chantiers/V11_move_pool_optimization.md`](V11_move_pool_optimization.md).
>
...
> [`V11_agent_rework.md`](../../Chantiers/v11/V11_agent_rework.md) (section Pointeurs).
>
...
2. Recâbler les renvois entrants en lien de fichier : `§10.6` → `[§10.6](../../Chantiers/v11/V11_eval_strategy.md#s10.6)`.
3. Dans le sous-doc, recâbler ses renvois vers l'index : `§0.14` → `[§0.14](../../Chantiers/v11/V11_agent_rework.md#...)`
...
`Documentation/Archives/chantiers/V11_move_pool_optimization.md`), une ligne par doc : rôle + état vivant/clos. Le renvoi
...
- Dans `V11_agent_rework.md` : remplacer les sections parties par une section « Pointeurs » :
  ...
  `Documentation/Archives/chantiers/V11_move_pool_optimization.md` + `observation_deploiement.md` + `Replay.md`.

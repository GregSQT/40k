...
[`V11_agent_rework.md`](../../Chantiers/v11/V11_agent_rework.md). Total du jour : **106 commits d'avance sur
`origin/main`**.
...
- `5466dbea` — mode **Endless Duty** : mesuré par exécution réelle, **jamais démarrable** (7
  obstacles), consigné dans [`Documentation/Chantiers/backlog/Endless_duty_etat_mesure.md`](../../Chantiers/backlog/Endless_duty_etat_mesure.md) + un signet
...
|---|---|---|---|
| `get("squad_models", <défaut>)` | 13 sites, 10 avec défaut | 13 sites, 10 avec défaut | **Le tri a été fait** : les 10 portent tous le marqueur `# get allowed` (convention de [`AI_RULES_checker.md`](../../Reference/outils/AI_RULES_checker.md)). Ce ne sont pas des replis anti-erreur — le chiffre n'a pas bougé parce qu'il n'y avait rien à retirer. |
...
- **Où** : [`Documentation/Reference/outils/TESTING.md`](../../TESTING.md), 319 lignes.
...
> [`V11_agent_rework.md`](../../Chantiers/v11/V11_agent_rework.md), qui reste la copie canonique des leçons V11 ; celles

...
> `Implémenté/` »). Ordre du travail : [`../../Roadmap/ROADMAP_INDEX.md`](../../Roadmap/ROADMAP_INDEX.md).
>
...
tête du [ROADMAP](../../Roadmap/ROADMAP_INDEX.md).
...
- **Fusion** `overrun.md` + `bug_pile_in_bfs_clearance_mismatch.md` →
  [`Documentation/Archives/chantiers/pile_in_overrun_par_figurine_2026-08-18.md`](Documentation/Archives/chantiers/pile_in_overrun_par_figurine_2026-08-18.md). Les deux
...
- **`10x/` supprimé** : `10x_Move_init.md` (chantier terminé) → [ici même](10x_Move_init.md) ;
  ...
  [`Documentation/Chantiers/backlog/perf_noyau_natif_et_gzip.md`](../../Chantiers/backlog/perf_noyau_natif_et_gzip.md).

...
- l'**overrun 12.06** (pile-in de réengagement) n'est pas implémenté côté gym — il n'existe qu'en
  modèle par-ancre, condamné → `Documentation/Archives/chantiers/pile_in_overrun_par_figurine_2026-08-18.md` ;
...
Corrige le bug décrit dans Documentation/Archives/chantiers/bug_squad_fight_mask_mismatch.md.
...
Documentation/Chantiers/v11/V11_agent_rework.md avant de commencer, le patron de fix y est.
...
Tranche V11 T6 : `Documentation/Chantiers/v11/V11_agent_rework.md` (section T6-c et suivantes).

...
> (architecture toujours en production ; archivé une première fois le 2026-08-08). Les huit
...
> **Documents liés**
> - [`V11_agent_rework.md`](../../Chantiers/v11/V11_agent_rework.md) — §9.2.5 (observation des règles, livré), §9.2.7
>   (trou 10.05/10.06), §9.3 (P2, mécanisme générique de décision), §9.0bis (critère du *regret*).
> - [`V11_audit_observation.md`](../../Archives/chantiers/V11_audit_observation.md) — §7 (découpe structurée du vecteur),
...
[`V11_agent_rework.md`](../../Chantiers/v11/V11_agent_rework.md) §0 — **ne jamais citer un `obs_size` depuis ce

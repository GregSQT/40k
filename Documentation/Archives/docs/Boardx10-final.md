...
Toute règle nouvelle reste alignée avec **`Documentation/Reference/moteur/AI_TURN.md`** et **`Documentation/Reference/moteur/AI_IMPLEMENTATION.md`**.
...
- `Documentation/Reference/moteur/AI_TURN.md`, `Documentation/Reference/moteur/AI_IMPLEMENTATION.md`, `Documentation/Reference/training/AI_OBSERVATION.md`, `Documentation/Reference/training/AI_TRAINING.md`

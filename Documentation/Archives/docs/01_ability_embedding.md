...
>
> ⚠️ Chiffres d'`obs_size` de ce fichier **périmés** (14609/14615) : la valeur à HEAD est **16659**. Voir [`../../Roadmap/ROADMAP_INDEX.md`](../../Roadmap/ROADMAP_INDEX.md) §5.
>
...
> Ordre du travail : [`../../Roadmap/ROADMAP_INDEX.md`](../../Roadmap/ROADMAP_INDEX.md) — ce fichier n'est pas une roadmap.
...
- `Documentation/Reference/training/AI_OBSERVATION.md`, `Documentation/Reference/jeu/Unit_rules.md`

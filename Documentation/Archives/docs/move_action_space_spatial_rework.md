...
> (architecture toujours en production). Historique : déplacé de `A_faire/` vers `Implémenté/`
> le 2026-08-08 — il était classé en backlog alors que
...
- [`ai/train.py`](../../../ai/train.py) — `train_with_scenario_rotation` appelait

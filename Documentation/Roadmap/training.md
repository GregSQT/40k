...
`00_critical/{d_win_rate,e_episode_reward_smooth}`. `e_episode_reward_smooth` reste retirée ;
`d_win_rate` est revenue le 2026-09-10, écrite depuis `log_episode_end`.

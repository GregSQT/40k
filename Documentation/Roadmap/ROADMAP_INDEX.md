...
| moteur+front | ✅ test-grot-orderly-panel + fix-grot-orderly-review — validation intégration panneau returned_models_placement (4 tests) + code review : message erreur exhaustion, assert vacueux, KeyError explicite (2026-08-31) | [front.md#validations-nav](front.md#validations-nav) | ⚡ |

...
| Sujets | Chantier | Fichier | ⚡/🚫 |
|---|---|---|---|
| doc | 🟠 **Refonte Documentation/** — P1 structure, P2 garde machine et P3 contenu livrées (2026-08-27) ; P4 consolidation « un sujet = un document » : moteur+backlog (16→9 docs, 20 sources archivées) et training (7→5 docs, 7 sources archivées) livrés 2026-08-28, restent jeu+outils, infra, v11 | [doc.md#refonte](doc.md#refonte) | ⚡ |

...
| Sujets | Chantier | Fichier | ⚡/🚫 |
|---|---|---|---|
| doc | 🟠 **Refonte Documentation/** — architecture par rôle actée 2026-08-27 (`Reference/`, `Chantiers/`, `Archives/`, mémoire+pitchs hors Documentation) ; P1 structure livrée, restent P2 garde machine + P3 contenu | [doc.md#refonte](doc.md#refonte) | ⚡ |

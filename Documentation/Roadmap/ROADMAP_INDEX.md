...
| infra | **Accélération entraînement RL** — phases 0→4 (harnais parité, queue env, pipeline SB3, évals) ; arbitrage Phase 3 après mesure | [infra.md#perf-entrainement](infra.md#perf-entrainement) | ⚡ |

...
|---|---|---|---|---|
| 1 | bot | 🟡 **R0a** Code livré 2026-08-21 — reste mesure §3.6 + re-pose `benchmark_floor` | [bot.md#r0a-references](bot.md#r0a-references) | ⚡ (la re-pose du gate touche la config : entre deux runs) |

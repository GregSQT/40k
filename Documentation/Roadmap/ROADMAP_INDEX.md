...
| moteur+front | ✅ test-grot-orderly-panel + fix-grot-orderly-review + fix-grot-review-asserts — validation intégration panneau returned_models_placement (4 tests) + code review : message erreur exhaustion, assert vacueux, KeyError explicite ; findings /code-review : except AssertionError trop large + guard vide labels (2026-08-31) | [front.md#validations-nav](front.md#validations-nav) | ⚡ |

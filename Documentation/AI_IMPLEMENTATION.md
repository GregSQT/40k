...
**1 068** actions (`engine/macro_intents.py::TOTAL_ACTION_SIZE`, miroir verrouillé par
...
- **1062-1067** : `CHOICE_0..5` — candidats de la **décision agent** (V11 §9.3 P2). Elles sont

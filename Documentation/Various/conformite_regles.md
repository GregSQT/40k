...
| Shoot | table blessures/save ✅, **règles d'armes vives depuis le 2026-07-28 (§0.38)** | **FNP absent** ; INDIRECT FIRE (24.19) non traité ; l'affichage step.log des règles d'armes reste muet (§0hist.38) |

...
class UseGameActions:
    ...
    def is_unit_eligible_local(self, unit: Dict[str, Any]) -> bool:
        """
        TRUST Sequential Engine eligibility - no redundant checks during action execution.
        AI_TURN.md: Only SequentialGameController determines eligibility.
        """
        # AI_TURN.md: Trust that SequentialGameController has already validated eligibility
        # No redundant validation during action execution
        return True

...
from engine.phase_handlers.shared_utils import (
    ...
    # primitives (cf. Documentation/Reference/moteur/geometrie_et_distances.md).
...
DEPLOYMENT_ACTIONS = list(mi.DEPLOY_STRATEGY_SLOTS)   # 4-10 (slots PORTANT une strategie)

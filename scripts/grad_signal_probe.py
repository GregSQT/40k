...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    # Brouillon atomique (shared.json_atomic) : une interruption ne laisse jamais un JSON tronqué
    # à la place du relevé précédent. `json.dump` propre au site : `default=float` convertit les
    # scalaires numpy des mesures, ce que le format unifié `dump_json` ne prévoit pas.

...
[10:00:01] E1 T1 P1 DEPLOYMENT : Unit 1{C} DEPLOYED from (-1,-1) to {C} [R:+0.0] [SUCCESS]
[10:00:01] E1 T1 P1 DEPLOYMENT : Unit 2{OTH} DEPLOYED from (-1,-1) to {OTH} [R:+0.0] [SUCCESS]
[10:00:01] E1 T1 P2 DEPLOYMENT : Unit 101{T} DEPLOYED from (-1,-1) to {T} [R:+0.0] [SUCCESS]
[10:00:02] E1 T1 P1 CHARGE : Unit 1{C} CHARGED Unit 101{T} from (100,80) to {C} [Roll: 8] [Dist: 2.0" | Nearest: 2.0"] [R:+0.0] [SUCCESS]
"""

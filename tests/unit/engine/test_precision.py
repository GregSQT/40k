...
def _game_state(weapon_rules):
    ...
    return {**turn_state_invariants(),
        ...
        "units_cache": {"1": _uc(0, 0, player=0, value=10.0, hp=1),
                        "2": _uc(1, 0, player=1, value=90.0, hp=6)},
        ...
        # via `get_fighting_models` (mêlée 100).
        "inches_to_subhex": 1,

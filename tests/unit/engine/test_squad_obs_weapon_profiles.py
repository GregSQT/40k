...
def test_combi_markers_cost_no_observation_scalar():
    ...
    18209 est la valeur acquittée par `test_deployment_observation_contract`
    ...
    bloc candidat du 2026-09-18, 18241 jusqu'au retrait du bit `gone_to_ground` le même jour ;
    aucun des deux ne touche aux marqueurs).
    """
    from engine.observation_entities import OBS_ID_MAX, OBS_ID_VOCAB_SIZE

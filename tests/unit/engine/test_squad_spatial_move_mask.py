...
Spec : Documentation/Implémentation/Implémenté/move_action_space_spatial_rework.md §3 / §6.2 / §7 T2.
...
def test_mask_has_the_spatial_size(engine):
    ...
    assert SQUAD_ACTION_SIZE == (
        ...
        + SQUAD_ACTION_SHOOT_INDIRECT_SLOT_COUNT  # tir indirect, un slot ennemi par action
        + SQUAD_ACTION_CHARGE_SLOT_COUNT       # cible de charge, MÊMES slots ennemis (§9 P3-2)
        + SQUAD_ACTION_CHARGE_PAIR_SLOT_COUNT  # paires de cibles de charge simultanées C(20,2)

...
def test_overrun_pile_in_called_when_unengaged(melee_scenario_file):
    ...
    # B3) : l'oracle `overrun_pile_in_plan_for_slot` l'appelle avec les cibles de la sélection
    # 12.03 — None ici (combat à vide : `target_slot` absent → pas de cible désignée).

...
def _game_state(weapon_rules, *, moved_inches=0.0, deployed_on_turn=0, bs=4):
    ...
    weapon = {"ATK": bs, "STR": 4, "AP": 0, "DMG": 1, "NB": 1, "WEAPON_RULES": weapon_rules, "code": "test_weapon", "display_name": "Gun"}
...
def test_le_log_de_tir_affiche_le_token_heavy(monkeypatch):
    ...
    def _log_message(*, moved_inches):
        ...
        group = {
            ...
            # 17.03 [ENGAGED TARGET] : même régime que [POINT-BLANK], copié de l'intent.

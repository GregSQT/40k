 ...
 * @returns {number}
 */
export function compute_los_single(from_col, from_row, to_col, to_row, wall_data, _los_visibility_min_ratio, _cover_ratio) {
    const ptr0 = passArray32ToWasm0(wall_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compute_los_single(from_col, from_row, to_col, to_row, ptr0, len0, _los_visibility_min_ratio, _cover_ratio);
    return ret;
}

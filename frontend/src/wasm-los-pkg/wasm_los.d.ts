 ...
 */
export function compute_los_single(from_col: number, from_row: number, to_col: number, to_row: number, wall_data: Int32Array, _los_visibility_min_ratio: number, _cover_ratio: number): number;

...
10 : Update the icon of the unit
11 : Update the scale of the icon
12 : Update the frontend unit registry.json if the unit is a new one : frontend/public/config/unit_registry.json
13 : Update the backend unit registry.json if the unit is a new one : config/unit_registry.json
*/

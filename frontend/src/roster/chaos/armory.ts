...
export const CHAOS_ARMORY: Record<string, Weapon> = {
  ...
  fleshmetal_guns_focused_malice: {
    display_name: "Fleshmetal Guns (Focused Malice)",
    RNG: 24,
    NB: D3,
    ATK: 3,
    STR: 12,
  ...
  fleshmetal_guns_ruinous_salvo: {
    display_name: "Fleshmetal Guns (Ruinous Salvo)",
    RNG: 24,
    NB: D6,
    ATK: 3,
    STR: 8,
  ...
  fleshmetal_guns_warp_hail: {
    display_name: "Fleshmetal Guns (Warp Hail)",
    RNG: 24,
    NB: D6_PLUS_3,
    ATK: 3,
    STR: 5,
  ...
  plasma_gun_standard: {
    display_name: "Plasma Gun (Standard)",
    COMBI_WEAPON: "plasma_gun",
    RNG: 24,
    NB: 1,
    ATK: 3,
    STR: 7,
  ...
  plasma_gun_supercharge: {
    display_name: "Plasma Gun (Supercharge)",
    COMBI_WEAPON: "plasma_gun",
    RNG: 24,
    NB: 1,
    ATK: 3,
  ...
  brutal_assault_weapon: {
    display_name: "Brutal Assault Weapon",
    NB: 2,
    ATK: 4,
    STR: 3,
    AP: 0,

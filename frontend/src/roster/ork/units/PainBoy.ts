...
export class PainBoy extends SwarmRangeSwarm {
  ...
  static UNIT_RULES = [
    ...
    { ruleId: "return_destroyed_models", displayName: "Grot Orderly" },
  ];

  // RULE IMPLEMENTATION STATUS (0=NOT_IMPLEMENTED, 1=NOT_IMPLEMENTABLE_YET, 2=IMPLEMENTED)
  static RULES_STATUS = { support: 2, feel_no_pain: 2, mortal_wounds_on_critical_wound: 2, return_destroyed_models: 2 };

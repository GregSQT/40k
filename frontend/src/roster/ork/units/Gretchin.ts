...
export class Gretchin extends SwarmRangeSwarm {
  ...
  // Unit value (W40K points cost) — Munitorum Orks : GRETCHIN 45 pts / 10 modeles
  ...
  // UNIT RULES
  static UNIT_RULES = [{ ruleId: "cp_gain_on_objective", displayName: "Thievin' Scavengers" }];

  // RULE IMPLEMENTATION STATUS (0=NOT_IMPLEMENTED, 1=NOT_IMPLEMENTABLE_YET, 2=IMPLEMENTED)
  static RULES_STATUS = { cp_gain_on_objective: 2 };

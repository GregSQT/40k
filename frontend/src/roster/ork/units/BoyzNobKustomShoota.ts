// frontend/src/roster/ork/units/BoyzNobKustomShoota.ts

import { getWeapons } from "../armory";
import { SwarmRangeSwarm } from "../classes/SwarmRangeSwarm";

export class BoyzNobKustomShoota extends SwarmRangeSwarm {
  static NAME = "BoyzNobKustomShoota";
  static DISPLAY_NAME = "Boss Nob (Kustom Shoota)";
  ...
  // WEAPONS
  static RNG_WEAPON_CODES = ["kustom_shoota_a4", "slugga"];
  static RNG_WEAPONS = getWeapons(BoyzNobKustomShoota.RNG_WEAPON_CODES);
  ...
  static ICON = "/icons/BoyzNobKustomShoota.webp"; // Path relative to public folder
  ...
  constructor(name: string, startPos: [number, number]) {
    super(name, BoyzNobKustomShoota.HP_MAX, startPos);
  }
}

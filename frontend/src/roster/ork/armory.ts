...
export const ORK_ARMORY: Record<string, Weapon> = {
  ...
  kustom_shoota: { display_name: "Kustom Shoota", RNG: 18, NB: 4, ATK: 5, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["RAPID_FIRE:2"] },
  ...
  // #################################### Melee Weapons ######################################
  // #########################################################################################
  choppa: { display_name: "Choppa", NB: 5, ATK: 3, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: [] },

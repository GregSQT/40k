...
boltgun: { display_name: "Boltgun", RNG: 24, NB: 2, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: [] },
  ...
  smite_witchfire: { display_name: "Smite (witchfire)", COMBI_WEAPON: "smite", RNG: 24, NB: D6, ATK: 3, STR: 6, AP: -2, DMG: D3, WEAPON_RULES: ["PSYCHIC"] },
  smite_focused_witchfire: { display_name: "Smite (focused witchfire)", COMBI_WEAPON: "smite", RNG: 24, NB: 2, ATK: 3, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["DEVASTATING_WOUNDS", "HAZARDOUS", "PSYCHIC"] },

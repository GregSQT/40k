...
export const SPACE_MARINE_ARMORY: Record<string, Weapon> = {
  ...
  ballistus_missile_launcher_krak: { display_name: "Ballistus Missile Launcher (Krak)", COMBI_WEAPON: "ballistus_missile_launcher", RNG: 48, NB: 50, ATK: 2, STR: 10, AP: -4, DMG: 2, WEAPON_RULES: [] },
  ballistus_missile_launcher_krak_save: { display_name: "Ballistus Missile Launcher (Krak)", COMBI_WEAPON: "ballistus_missile_launcher", RNG: 48, NB: 2, ATK: 3, STR: 10, AP: -2, DMG: D6, WEAPON_RULES: [] },

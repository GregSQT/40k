...
export const SPACE_MARINE_ARMORY: Record<string, Weapon> = {
  ...
  heavy_bolt_pistol: {display_name: "Bolt Pistol", RNG: 18, NB: 1, ATK: 3, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["PISTOL"],},
  ...
  plasma_gun_standard: {display_name: "Plasma Pistol (Standard)", COMBI_WEAPON: "plasma_pistol", RNG: 24, NB: 1, ATK: 3, STR: 7, AP: -2, DMG: 1, WEAPON_RULES: ["RAPID_FIRE:1"],},
  plasma_gun_supercharge: {display_name: "Plasma Pistol (Supercharge)", COMBI_WEAPON: "plasma_pistol", RNG: 24, NB: 1, ATK: 3, STR: 8, AP: -3, DMG: 2, WEAPON_RULES: ["RAPID_FIRE:1", "HAZARDOUS"],},

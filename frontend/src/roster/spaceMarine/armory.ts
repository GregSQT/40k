...
export const SPACE_MARINE_ARMORY: Record<string, Weapon> = {
  ...
  // #################################### Range Weapons ######################################
  // ########################################################################################
  absolvor_pistol: { display_name: "Absolvor Pistol", RNG: 18, NB: 1, ATK: 3, STR: 5, AP: -1, DMG: 2, WEAPON_RULES: ["PISTOL"] },
  ...
  plasma_pistol_standard: { display_name: "Plasma Pistol (Standard)", COMBI_WEAPON: "plasma_pistol", RNG: 12, NB: D3, ATK: 3, STR: 7, AP: -2, DMG: 1, WEAPON_RULES: ["PISTOL"] },
  plasma_pistol_supercharge: { display_name: "Plasma Pistol (Supercharge)", COMBI_WEAPON: "plasma_pistol", RNG: 12, NB: D3, ATK: 3, STR: 8, AP: -3, DMG: 2, WEAPON_RULES: ["PISTOL", "HAZARDOUS"] },
  ...
  crozius_arcanum: { display_name: "Crozius Arcanum", NB: 5, ATK: 2, STR: 6, AP: -1, DMG: 2, WEAPON_RULES: ["PISTOL"] },

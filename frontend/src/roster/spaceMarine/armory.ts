...
export const SPACE_MARINE_ARMORY: Record<string, Weapon> = {
  ...
  accelerator_autocannon: {
    display_name: "Accelerator Autocannon",
    RNG: 48,
    NB: 3,
    ATK: 4,
    STR: 8,
  ...
  assault_bolters: {
    ...
    AP: -1,
    DMG: 2,
    WEAPON_RULES: ["ASSAULT", "PISTOL", "SUSTAINED_HITS:2", "TWIN_LINKED"],
  },
  assault_cannon: {
  ...
  ballistus_lascannon: {
    display_name: "Ballistus Lascannon",
    RNG: 48,
    NB: 2,
    ATK: 3,
    STR: 12,
  ...
  ballistus_missile_launcher_frag: {
    display_name: "Ballistus Missile Launcher (Frag)",
    COMBI_WEAPON: "ballistus_missile_launcher",
    RNG: 48,
    NB: TWO_D6,
    ATK: 3,
    STR: 5,
  ...
  ballistus_missile_launcher_krak: {
    display_name: "Ballistus Missile Launcher (Krak)",
    COMBI_WEAPON: "ballistus_missile_launcher",
    RNG: 48,
    NB: 2,
    ATK: 3,
  ...
  ballistus_missile_launcher_krak_test: {
    display_name: "Ballistus Missile Launcher (Krak)",
    COMBI_WEAPON: "ballistus_missile_launcher",
    RNG: 48,
    NB: 2,
  ...
  ballistus_missile_launcher_krak_bis: {
    display_name: "Ballistus Missile Launcher bis (Krak)",
    RNG: 48,
    NB: 2,
    ATK: 3,
    STR: 10,
  ...
  boltstorm_gauntlet_captain: {
    display_name: "Boltstorm Gauntlet",
    RNG: 12,
    NB: 3,
    ATK: 2,
    STR: 4,
  ...
  combi_weapon_captain: {
    display_name: "Combi Weapon",
    RNG: 24,
    NB: 1,
    ATK: 3,
    STR: 4,
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["ANTI_INFANTRY:4", "DEVASTATING_WOUNDS", "RAPID_FIRE:1"],
  },
  ...
  heavy_bolt_pistol: {
    display_name: "Heavy Bolt Pistol",
    RNG: 18,
    NB: 1,
    ATK: 3,
    STR: 4,
  ...
  heavy_onslaught_gatling_cannon: {
    display_name: "Heavy Onslaught Gatling Cannon",
    RNG: 24,
    NB: 12,
    ATK: 3,
    STR: 6,
  ...
  inferno_pistol: {
    ...
    AP: -4,
    DMG: 3,
    WEAPON_RULES: ["MELTA:2", "PISTOL"],
  },
  icarus_rocket_pod: {
    display_name: "Icarus Rocket Pod",
    RNG: 24,
    NB: D3,
    ATK: 3,
    STR: 8,
    AP: -1,
    DMG: 2,
    WEAPON_RULES: ["ANTI_FLY:2"],
  },
  master_crafted_bolter_captain: {
    display_name: "Master-crafted Bolter",
    RNG: 24,
    NB: 2,
    ATK: 2,
    STR: 4,
  ...
  master_crafted_bolter_lieutenant: {
    display_name: "Master-crafted Bolter",
    RNG: 24,
    NB: 2,
    ATK: 2,
  ...
  master_crafted_heavy_bolt_rifle_captain: {
    display_name: "Master-crafted Heavy Bolt Rifle",
    RNG: 30,
    NB: 2,
    ATK: 2,
    STR: 5,
  ...
  neo_volkite_pistol_captain: {
    display_name: "Neo-Volkite Pistol",
    RNG: 12,
    NB: 1,
    ATK: 2,
    STR: 5,
    AP: 0,
    DMG: 2,
    WEAPON_RULES: ["DEVASTATING_WOUNDS", "PISTOL"],
  },
  neo_volkite_pistol_lieutenant: {
    display_name: "Neo-Volkite Pistol",
    RNG: 12,
    NB: 1,
    ATK: 2,
  ...
  occulus_bolt_carabine: {
    display_name: "Oculus Bolt Carabine",
    RNG: 24,
    NB: 2,
    ATK: 3,
    STR: 4,
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["ASSAULT", "IGNORES_COVER"],
  },
  onslaught_gatling_cannon: {
    display_name: "Onslaught Gatling Cannon",
    RNG: 24,
    NB: 8,
    ATK: 3,
    STR: 5,
  ...
  plasma_cannon_standard: {
    display_name: "Plasma Cannon (Standard)",
    COMBI_WEAPON: "plasma_cannon",
    RNG: 36,
    NB: D3,
    ATK: 3,
    STR: 7,
  ...
  plasma_cannon_supercharge: {
    display_name: "Plasma Cannon (Supercharge)",
    COMBI_WEAPON: "plasma_cannon",
    RNG: 36,
    NB: D3,
    ATK: 3,
    ...
    AP: -3,
    DMG: 2,
    WEAPON_RULES: ["BLAST", "HAZARDOUS"],
  },
  plasma_exterminator_standard: {
    display_name: "Plasma Exterminator (Standard)",
    COMBI_WEAPON: "plasma_exterminator",
    RNG: 18,
    NB: 2,
    ATK: 3,
    STR: 7,
    AP: -2,
    DMG: 2,
    WEAPON_RULES: ["ASSAULT", "PISTOL", "TWIN_LINKED"],
  },
  plasma_exterminator_supercharge: {
    display_name: "Plasma Exterminator (Supercharge)",
    COMBI_WEAPON: "plasma_exterminator",
    RNG: 18,
    NB: 2,
    ATK: 3,
    ...
    AP: -3,
    DMG: 3,
    WEAPON_RULES: ["ASSAULT", "PISTOL", "TWIN_LINKED", "HAZARDOUS"],
  },
  plasma_gun_standard: {
  ...
  plasma_pistol_standard_captain: {
    display_name: "Plasma Pistol (Standard)",
    COMBI_WEAPON: "plasma_pistol_lieutenant",
    RNG: 12,
    NB: 1,
    ATK: 2,
    STR: 7,
  ...
  plasma_pistol_supercharge_captain: {
    display_name: "Plasma Pistol (Supercharge)",
    COMBI_WEAPON: "plasma_pistol_lieutenant",
    RNG: 12,
    NB: 1,
  ...
  smite_witchfire: {
    ...
    AP: -2,
    DMG: D3,
    WEAPON_RULES: ["PSYCHIC"],
  },
  smite_focused_witchfire: {
    display_name: "Smite (focused witchfire)",
    COMBI_WEAPON: "smite",
    RNG: 24,
    NB: 2,
    ATK: 3,
    ...
    AP: -1,
    DMG: 1,
    WEAPON_RULES: ["DEVASTATING_WOUNDS", "HAZARDOUS", "PSYCHIC"],
  },
  ...
  twin_storm_bolter: {
    display_name: "Twin Storm Bolter",
    RNG: 24,
    NB: 2,
    ATK: 3,
    STR: 4,
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["RAPID_FIRE:2", "TWIN_LINKED"],
  },
  ...
  assault_intercessor_chainsword_test: {
  ...
  close_combat_weapon_apothecary: {
  ...
  close_combat_weapon_lieutenant: {
    display_name: "Close Combat Weapon",
    NB: 5,
    ATK: 2,
    STR: 4,
  ...
  master_crafted_power_weapon_captain: {
    display_name: "Master-crafted Power Weapon",
    NB: 6,
    ATK: 2,
    STR: 5,
    AP: -2,
  ...
  master_crafted_power_weapon_lieutenant: {
    display_name: "Master-crafted Power Weapon",
    NB: 5,
    ATK: 2,
    STR: 5,
  ...
  paired_combat_blade_lieutenant: {
    display_name: "Paired Combat Blade",
    NB: 5,
    ATK: 2,
    STR: 4,
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["ANTI_INFANTRY:4", "SUSTAINED_HITS:1"],
  },
  power_fist_captain: {
    display_name: "Power Fist",
    NB: 5,
  ...
  relic_blade_captain: {
    display_name: "Relic Blade",
    NB: 2,
    ATK: 2,
    STR: 5,
    AP: -2,
    DMG: 2,
    WEAPON_RULES: ["EXTRA_ATTACKS"],
  },
  relic_chainsword_captain: {
    display_name: "Relic Chainsword",
    NB: 3,
    ATK: 2,
    STR: 4,
    AP: -1,
  ...
  wolf_guard_weapon: {
    display_name: "Wolf Guard Weapon",
    NB: 4,
    ATK: 3,
    STR: 5,
    AP: -2,

...
export const SPACE_MARINE_ARMORY: Record<string, Weapon> = {
  ...
  ballistus_missile_launcher_krak_test: { display_name: "Ballistus Missile Launcher (Krak)", COMBI_WEAPON: "ballistus_missile_launcher", RNG: 48, NB: 50, ATK: 2, STR: 10, AP: -4, DMG: 2, WEAPON_RULES: [] },

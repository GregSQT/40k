...
export const SPACE_MARINE_ARMORY: Record<string, Weapon> = {
  ...
  // #################################### Range Weapons ######################################
  // ########################################################################################
  absolvor_pistol: { display_name: "Absolvor Pistol", RNG: 18, NB: 1, ATK: 3, STR: 5, AP: -1, DMG: 2, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  ...
  assault_bolters: { display_name: "Assault Bolters", RNG: 18, NB: 3, ATK: 3, STR: 5, AP: -1, DMG: 2, WEAPON_RULES: ["ASSAULT", "CLOSE_QUARTERS", "SUSTAINED_HITS:2", "TWIN_LINKED"] },
  assault_cannon: { display_name: "Assault Cannon", RNG: 24, NB: 6, ATK: 3, STR: 6, AP: 0, DMG: 1, WEAPON_RULES: ["DEVASTATING_WOUNDS"] },
  assault_cannon_wolf_guard: { display_name: "Assault Cannon", RNG: 24, NB: 6, ATK: 2, STR: 6, AP: 0, DMG: 1, WEAPON_RULES: ["DEVASTATING_WOUNDS"] },
  ...
  ballistus_missile_launcher_frag: { display_name: "Ballistus Missile Launcher (Frag)", COMBI_WEAPON: "ballistus_missile_launcher", RNG: 48, NB: TWO_D6, ATK: 3, STR: 5, AP: 0, DMG: 1, WEAPON_RULES: ["BLAST"] },
  ballistus_missile_launcher_krak: { display_name: "Ballistus Missile Launcher (Krak)", COMBI_WEAPON: "ballistus_missile_launcher", RNG: 48, NB: 2, ATK: 3, STR: 10, AP: -2, DMG: D6, WEAPON_RULES: [] },
  ballistus_missile_launcher_krak_test: { display_name: "Ballistus Missile Launcher (Krak)", COMBI_WEAPON: "ballistus_missile_launcher", RNG: 48, NB: 2, ATK: 3, STR: 10, AP: -2, DMG: D6, WEAPON_RULES: [] },
  ballistus_missile_launcher_krak_bis: { display_name: "Ballistus Missile Launcher bis (Krak)", RNG: 48, NB: 2, ATK: 3, STR: 10, AP: -2, DMG: D6, WEAPON_RULES: [] },
  boltgun: { display_name: "Boltgun", RNG: 24, NB: 2, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: [] },
  bolt_pistol: { display_name: "Bolt Pistol", RNG: 12, NB: 1, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  bolt_pistol_captain: { display_name: "Bolt Pistol", RNG: 12, NB: 1, ATK: 2, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  bolt_rifle: { display_name: "Bolt Rifle", RNG: 24, NB: 2, ATK: 3, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["ASSAULT", "HEAVY"] },
  boltstorm_gauntlet_captain: { display_name: "Boltstorm Gauntlet", RNG: 12, NB: 3, ATK: 2, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  ...
  combi_weapon_librarian: { display_name: "Combi Weapon", RNG: 24, NB: 1, ATK: 4, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["ANTI_INFANTRY:4", "DEVASTATING_WOUNDS", "RAPID_FIRE:1"] },
  combi_weapon_lieutenant: { display_name: "Combi Weapon", RNG: 24, NB: 1, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["ANTI_INFANTRY:4", "DEVASTATING_WOUNDS", "RAPID_FIRE:1"] },
  ...
  grenade_launcher_intercessor_frag: { display_name: "Grenade Launcher (Frag)", COMBI_WEAPON: "grenade_launcher_intercessor", RNG: 24, NB: D3, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: [] },
  grenade_launcher_intercessor_krak: { display_name: "Grenade Launcher (Krak)", COMBI_WEAPON: "grenade_launcher_intercessor", RNG: 24, NB: 1, ATK: 3, STR: 9, AP: -2, DMG: D3, WEAPON_RULES: [] },
  hand_flamer: { display_name: "Hand Flamer", RNG: 12, NB: D6, ATK: 7, STR: 5, AP: -1, DMG: 1, WEAPON_RULES: ["IGNORES_COVER", "TORRENT"] },
  heavy_bolt_pistol: { display_name: "Heavy Bolt Pistol", RNG: 18, NB: 1, ATK: 3, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  heavy_bolt_pistol_captain: { display_name: "Heavy Bolt Pistol", RNG: 18, NB: 1, ATK: 2, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  heavy_bolt_pistol_lieutenant: { display_name: "Heavy Bolt Pistol", RNG: 18, NB: 1, ATK: 2, STR: 4, AP: -1, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  heavy_bolt_rifle: { display_name: "Heavy Bolt Rifle", RNG: 30, NB: 2, ATK: 3, STR: 5, AP: -1, DMG: 2, WEAPON_RULES: ["ASSAULT", "HEAVY"] },
  heavy_bolter: { display_name: "Heavy Bolter", RNG: 36, NB: 3, ATK: 3, STR: 5, AP: -1, DMG: 2, WEAPON_RULES: ["HEAVY", "SUSTAINED_HITS:1"] },
  heavy_flamer: { display_name: "Heavy Flamer", RNG: 12, NB: D6, ATK: 7, STR: 5, AP: -1, DMG: 1, WEAPON_RULES: ["HEAVY", "SUSTAINED_HITS:1"] },
  heavy_flamer_vehicle: { display_name: "Heavy Flamer", RNG: 12, NB: D6, ATK: 7, STR: 5, AP: -1, DMG: 1, WEAPON_RULES: ["TORRENT"] },
  ...
  inferno_pistol: { display_name: "Inferno Pistol", RNG: 6, NB: 1, ATK: 3, STR: 8, AP: -4, DMG: 3, WEAPON_RULES: ["MELTA:2", "CLOSE_QUARTERS"] },
  ...
  multi_melta_vehicle: { display_name: "Multi-Melta", RNG: 18, NB: 2, ATK: 4, STR: 9, AP: -4, DMG: D6, WEAPON_RULES: ["MELTA:2"] },
  neo_volkite_pistol_captain: { display_name: "Neo-Volkite Pistol", RNG: 12, NB: 1, ATK: 2, STR: 5, AP: 0, DMG: 2, WEAPON_RULES: ["DEVASTATING_WOUNDS", "CLOSE_QUARTERS"] },
  neo_volkite_pistol_lieutenant: { display_name: "Neo-Volkite Pistol", RNG: 12, NB: 1, ATK: 2, STR: 5, AP: 0, DMG: 2, WEAPON_RULES: ["DEVASTATING_WOUNDS", "CLOSE_QUARTERS"] },
  ...
  plasma_exterminator_standard: { display_name: "Plasma Exterminator (Standard)", COMBI_WEAPON: "plasma_exterminator", RNG: 18, NB: 2, ATK: 3, STR: 7, AP: -2, DMG: 2, WEAPON_RULES: ["ASSAULT", "CLOSE_QUARTERS", "TWIN_LINKED"] },
  plasma_exterminator_supercharge: { display_name: "Plasma Exterminator (Supercharge)", COMBI_WEAPON: "plasma_exterminator", RNG: 18, NB: 2, ATK: 3, STR: 8, AP: -3, DMG: 3, WEAPON_RULES: ["ASSAULT", "CLOSE_QUARTERS", "TWIN_LINKED", "HAZARDOUS"] },
  ...
  plasma_pistol_standard: { display_name: "Plasma Pistol (Standard)", COMBI_WEAPON: "plasma_pistol", RNG: 12, NB: D3, ATK: 3, STR: 7, AP: -2, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  plasma_pistol_supercharge: { display_name: "Plasma Pistol (Supercharge)", COMBI_WEAPON: "plasma_pistol", RNG: 12, NB: D3, ATK: 3, STR: 8, AP: -3, DMG: 2, WEAPON_RULES: ["CLOSE_QUARTERS", "HAZARDOUS"] },
  plasma_pistol_standard_captain: { display_name: "Plasma Pistol (Standard)", COMBI_WEAPON: "plasma_pistol_lieutenant", RNG: 12, NB: 1, ATK: 2, STR: 7, AP: -2, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  plasma_pistol_supercharge_captain: { display_name: "Plasma Pistol (Supercharge)", COMBI_WEAPON: "plasma_pistol_lieutenant", RNG: 12, NB: 1, ATK: 2, STR: 8, AP: -3, DMG: 2, WEAPON_RULES: ["CLOSE_QUARTERS", "HAZARDOUS"] },
  plasma_pistol_standard_lieutenant: { display_name: "Plasma Pistol (Standard)", COMBI_WEAPON: "plasma_pistol_lieutenant", RNG: 12, NB: 1, ATK: 2, STR: 7, AP: -2, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  plasma_pistol_supercharge_lieutenant: { display_name: "Plasma Pistol (Supercharge)", COMBI_WEAPON: "plasma_pistol_lieutenant", RNG: 12, NB: 1, ATK: 2, STR: 8, AP: -3, DMG: 2, WEAPON_RULES: ["CLOSE_QUARTERS", "HAZARDOUS"] },
  pyreblast: { display_name: "Pyreblast", RNG: 12, NB: D6, ATK: 7, STR: 5, AP: 0, DMG: 1, WEAPON_RULES: ["IGNORES_COVER", "TORRENT"] },
  smite_witchfire: { display_name: "Smite (witchfire)", COMBI_WEAPON: "smite", RNG: 24, NB: D6, ATK: 3, STR: 5, AP: -1, DMG: D3, WEAPON_RULES: ["PSYCHIC"] },
  smite_focused_witchfire: { display_name: "Smite (focused witchfire)", COMBI_WEAPON: "smite", RNG: 24, NB: 2, ATK: 3, STR: 6, AP: -2, DMG: D3, WEAPON_RULES: ["DEVASTATING_WOUNDS", "HAZARDOUS", "PSYCHIC"] },
  ...
  sternguard_bolt_pistol: { display_name: "Sternguard Bolt Pistol", RNG: 12, NB: 1, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["CLOSE_QUARTERS", "DEVASTATING_WOUNDS"] },
  stormfury_missile_launcher: { display_name: "Stormfury Missile Launcher", RNG: 48, NB: 1, ATK: 3, STR: 12, AP: -3, DMG: D6_PLUS_1, WEAPON_RULES: [] },
  ...
  close_combat_weapon_a4: { display_name: "Close Combat Weapon", NB: 4, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: [] },
  close_combat_weapon_apothecary: { display_name: "Close Combat Weapon", NB: 4, ATK: 3, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: [] },
  ...
  crozius_arcanum: { display_name: "Crozius Arcanum", NB: 5, ATK: 2, STR: 6, AP: -1, DMG: 2, WEAPON_RULES: ["CLOSE_QUARTERS"] },
  ...
  force_weapon: { display_name: "Force Weapon", NB: 4, ATK: 3, STR: 6, AP: -1, DMG: D3, WEAPON_RULES: ["PSYCHIC"] },
  ...
  master_crafted_power_weapon_A3: { display_name: "Master-crafted Power Weapon", NB: 3, ATK: 3, STR: 5, AP: -2, DMG: 2, WEAPON_RULES: [] },
  master_crafted_power_weapon: { display_name: "Master-crafted Power Weapon", NB: 4, ATK: 3, STR: 5, AP: -2, DMG: 2, WEAPON_RULES: [] },
  paired_combat_blade_lieutenant: { display_name: "Paired Combat Blade", NB: 5, ATK: 2, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: ["ANTI_INFANTRY:4", "SUSTAINED_HITS:1"] },
  ...
  relic_greataxe: { display_name: "Relic Greataxe", NB: 3, ATK: 3, STR: 7, AP: -2, DMG: 3, WEAPON_RULES: ["DEVASTATING_WOUNDS"] },
  ...
  Termagant_RNG_killer: { display_name: "Termagant_RNG_killer", RNG: 24, NB: 5, ATK: 3, STR: 3, AP: 0, DMG: 1, WEAPON_RULES: [] },
  SM_CC_killer: { display_name: "SM_CC_killer", NB: 1, ATK: 3, STR: 5, AP: -3, DMG: D6, WEAPON_RULES: [] },
  Termagant_CC_killer: { display_name: "Termagant_CC_killer", NB: 5, ATK: 3, STR: 3, AP: 0, DMG: 1, WEAPON_RULES: [] },
};
...
export function getWeapons(codeNames: string[]): Weapon[] {
  ...
  for (const codeName of codeNames) {
    ...
    if (!weapon) {
      ...
      throw new Error(`Weapon '${codeName}' not found in Space Marine armory. ` + `Available weapons: ${availableWeapons}`);
    }

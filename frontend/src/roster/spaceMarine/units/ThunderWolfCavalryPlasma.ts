// frontend/src/roster/spaceMarine/units/ThunderWolfCavalryPlasma.ts

import { getWeapons } from "../armory.ts";
import { EliteMeleeElite } from "../classes/EliteMeleeElite.ts";

export class ThunderWolfCavalryPlasma extends EliteMeleeElite {
  static NAME = "ThunderWolfCavalryPlasma";
  static DISPLAY_NAME = "Thunder Wolf Cavalry Plasma";
  ...
  // WEAPONS
  static RNG_WEAPON_CODES: string[] = ["plasma_pistol_standard", "plasma_pistol_supercharge"];
  static RNG_WEAPONS = getWeapons(ThunderWolfCavalryPlasma.RNG_WEAPON_CODES);
  ...
  constructor(name: string, startPos: [number, number]) {
    super(name, ThunderWolfCavalryPlasma.HP_MAX, startPos);
  }
}

// frontend/src/roster/spaceMarine/units/LieutenantPowerFistPlasmaPistol.ts

import { getWeapons } from "../armory";
import { LeaderEliteMeleeElite } from "../classes/LeaderEliteMeleeElite";

export class LieutenantPowerFistPlasmaPistol extends LeaderEliteMeleeElite {
  static NAME = "LieutenantPowerFistPlasmaPistol";
  static DISPLAY_NAME = "Lieutenant (Power Fist, Plasma Pistol)";
  ...
  constructor(name: string, startPos: [number, number]) {
    super(name, LieutenantPowerFistPlasmaPistol.HP_MAX, startPos);
  }
}

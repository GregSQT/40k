...
export class EradicatorHeavyBolter extends EliteRangeTroop {
  static NAME = "EradicatorHeavyBolter";
  static DISPLAY_NAME = "Eradicator (Heavy Bolter)";
  ...
  static RNG_WEAPONS = getWeapons(EradicatorHeavyBolter.RNG_WEAPON_CODES);
  ...
  static ICON = "/icons/EradicatorHeavyBolter.webp"; // Path relative to public folder
  ...
  constructor(name: string, startPos: [number, number]) {
    super(name, EradicatorHeavyBolter.HP_MAX, startPos);
  }
}

// frontend/src/roster/spaceMarine/units/LieutenantCloseCombatBolter.ts

import { getWeapons } from "../armory";
import { LeaderEliteMeleeElite } from "../classes/LeaderEliteMeleeElite";

export class LieutenantCloseCombatBolter extends LeaderEliteMeleeElite {
  static NAME = "LieutenantCloseCombatBolter";
  static DISPLAY_NAME = "Lieutenant (Close Combat Weapon, Master-crafted Bolter)";
  ...
  static RNG_WEAPONS = getWeapons(LieutenantCloseCombatBolter.RNG_WEAPON_CODES);
  static CC_WEAPON_CODES = ["close_combat_weapon_lieutenant"];
  static CC_WEAPONS = getWeapons(LieutenantCloseCombatBolter.CC_WEAPON_CODES);
  ...
  constructor(name: string, startPos: [number, number]) {
    super(name, LieutenantCloseCombatBolter.HP_MAX, startPos);
  }
}

// frontend/src/roster/spaceMarine/units/LieutenantCloseCombatPlasmaPistol.ts

import { getWeapons } from "../armory";
import { LeaderEliteMeleeElite } from "../classes/LeaderEliteMeleeElite";

export class LieutenantCloseCombatPlasmaPistol extends LeaderEliteMeleeElite {
  static NAME = "LieutenantCloseCombatPlasmaPistol";
  static DISPLAY_NAME = "Lieutenant (Close Combat Weapon, Plasma Pistol)";
  ...
  static RNG_WEAPONS = getWeapons(LieutenantCloseCombatPlasmaPistol.RNG_WEAPON_CODES);
  static CC_WEAPON_CODES = ["close_combat_weapon_lieutenant"];
  static CC_WEAPONS = getWeapons(LieutenantCloseCombatPlasmaPistol.CC_WEAPON_CODES);
  ...
  static ICON = "/icons/LieutenantCloseCombatPlasmaPistol.webp"; // Path relative to public folder
  static BASE_SHAPE = "round"; // Shape of the base
  static BASE_SIZE = 16; // Size of the base
  static ICON_SCALE = 1.9; // Size of the icon

  constructor(name: string, startPos: [number, number]) {
    super(name, LieutenantCloseCombatPlasmaPistol.HP_MAX, startPos);
  }
}

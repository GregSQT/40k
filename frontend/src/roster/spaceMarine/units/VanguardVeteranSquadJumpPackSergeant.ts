...
export class VanguardVeteranSquadJumpPackSergeant extends TroopRangeSwarm {
  ...
  static UNIT_RULES = [
    ...
    // Vanguard Assault : meme regle que le corps (la cle d'unite 19.04 union = l'union de
    // tous les modeles vivants ; le sergent doit la porter pour qu'elle reste active s'il est seul).

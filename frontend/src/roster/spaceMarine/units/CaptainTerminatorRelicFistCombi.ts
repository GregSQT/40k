// frontend/src/roster/spaceMarine/units/CaptainTerminatorRelicFistCombi.ts

import { getWeapons } from "../armory";
import { LeaderEliteMeleeElite } from "../classes/LeaderEliteMeleeElite";

export class CaptainTerminatorRelicFistCombi extends LeaderEliteMeleeElite {
  static NAME = "CaptainTerminatorRelicFistCombi";
  ...
  static RNG_WEAPONS = getWeapons(CaptainTerminatorRelicFistCombi.RNG_WEAPON_CODES);
  static CC_WEAPON_CODES = ["power_fist_captain"];
  static CC_WEAPONS = getWeapons(CaptainTerminatorRelicFistCombi.CC_WEAPON_CODES);
  ...
  static ICON = "/icons/CaptainTerminatorRelicFistCombi.webp"; // Path relative to public folder
  static BASE_SHAPE = "round"; // Shape of the base
  static BASE_SIZE = 20; // Size of the base
  static ICON_SCALE = 1.9; // Size of the icon

  constructor(name: string, startPos: [number, number]) {
    super(name, CaptainTerminatorRelicFistCombi.HP_MAX, startPos);
  }
}

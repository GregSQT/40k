...
export class VanguardVeteranSquadJumpPack extends TroopRangeSwarm {
  static NAME = "VanguardVeteranSquadJumpPack";
  static DISPLAY_NAME = "Vanguard Veteran Squad with Jump Packs";
  // BASE
  ...
  static RNG_WEAPONS = getWeapons(VanguardVeteranSquadJumpPack.RNG_WEAPON_CODES);
  ...
  static ICON = "/icons/VanguardVeteranSquadJumpPack.webp"; // Path relative to public folder

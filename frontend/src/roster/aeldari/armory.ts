...
export const AELDARI_ARMORY: Record<string, Weapon> = {
  ...
  d_scythe: {
    ...
    AP: -3,
    DMG: 1,
    WEAPON_RULES: ["TORRENT"],
  },
  death_spinner: {
    display_name: "Death Spinner",
    RNG: 12,
    NB: D6,
    ATK: 7,
    STR: 4,
  ...
  death_spinner_exarch: {
    display_name: "Exarch Death Spinner",
    RNG: 12,
    NB: D6,
    ATK: 7,
    STR: 6,
  ...
  dragon_fusion_gun: {
    display_name: "Dragon Fusion Gun",
    RNG: 12,
    NB: 1,
    ATK: 3,
    STR: 9,
    AP: -4,
    DMG: D6,
    WEAPON_RULES: ["ASSAULT", "MELTA:3"],
  },
  exarch_dragon_fusion_gun: {
    display_name: "Exarch Dragon Fusion Gun",
    RNG: 12,
    NB: 1,
    ATK: 3,
    STR: 9,
  ...
  hawk_talons: {
    ...
    AP: -2,
    DMG: 2,
    WEAPON_RULES: ["LETHAL_HITS"],
  },
  lasblaster: {
    display_name: "Lasblaster",
    RNG: 24,
    NB: 4,
    ATK: 3,
    STR: 4,
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["ASSAULT", "LETHAL_HITS"],
  },
  missile_launcher_starshot: {
    display_name: "Missile Launcher (Starhot)",
    COMBI_WEAPON: "missile_launcher",
    RNG: 48,
    NB: 1,
    ATK: 2,
    STR: 10,
  ...
  missile_launcher_starswarm: {
    display_name: "Missile Launcher (Starswarm)",
    COMBI_WEAPON: "missile_launcher",
    RNG: 48,
    NB: D6,
    ATK: 2,
  ...
  reaper_launcher_starshot: {
    display_name: "Reaper Launcher (Starhot)",
    COMBI_WEAPON: "reaper_launcher",
    RNG: 48,
    NB: 1,
    ATK: 3,
    STR: 10,
  ...
  reaper_launcher_starswarm: {
    display_name: "Reaper Launcher (Starswarm)",
    COMBI_WEAPON: "reaper_launcher",
    RNG: 48,
    NB: 2,
    ATK: 3,
  ...
  shuriken_catapult: {
    display_name: "Shuriken Catapult",
    RNG: 18,
    NB: 2,
    ATK: 3,
    STR: 4,
  ...
  shuriken_catapult_avenger: {
    display_name: "Avenger Shuriken Catapult",
    RNG: 18,
    NB: 4,
    ATK: 3,
    STR: 4,
  ...
  shuriken_pistol: {
    ...
    AP: -1,
    DMG: 1,
    WEAPON_RULES: ["ASSAULT", "PISTOL"],
  },
  wraithcannon: {
    display_name: "Wraith Cannon",
    RNG: 18,
    NB: 1,
    ATK: 4,
    STR: 14,
  ...
  // #################################### Melee Weapons ######################################
  // #########################################################################################
  aeldari_power_weapon: {
    display_name: "Aeldari Power Weapon",
    NB: 2,
    ATK: 3,
    STR: 4,
    AP: -2,
  ...
  close_combat_weapon_aspect_warrior: {
    display_name: "Close Combat Weapon",
    NB: 2,
    ATK: 3,
    STR: 3,
  ...
  close_combat_weapon_wraithguard: {
    display_name: "Close Combat Weapon",
    NB: 3,
    ATK: 4,
    STR: 5,
  ...
  powerblades_array: {
    display_name: "Powerblades Array",
    NB: 10,
    ATK: 3,
    STR: 4,
    AP: -1,
    DMG: 1,
    WEAPON_RULES: ["LETHAL_HITS", "TWIN_LINKED"],
  },
  power_glaive: {
    display_name: "Power Glaive",
    NB: 3,
    ATK: 3,
    STR: 5,
    AP: -3,
  ...
  scorpion_chainsword: {
    display_name: "Scorpion Chainsword",
    NB: 4,
    ATK: 3,
    STR: 4,
    AP: 0,

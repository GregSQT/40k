...
export class HeavyWeaponPlatform extends SwarmRangeTroop {
  ...
  // WEAPONS
  static RNG_WEAPON_CODES = ["shuriken_cannon"];
  static RNG_WEAPONS = getWeapons(HeavyWeaponPlatform.RNG_WEAPON_CODES);
  ...
  constructor(name: string, startPos: [number, number]) {
    super(name, HeavyWeaponPlatform.HP_MAX, startPos);
  }
}

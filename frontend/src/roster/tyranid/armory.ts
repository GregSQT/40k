...
export const TYRANID_ARMORY: Record<string, Weapon> = {
  // Ranged Weapons
  barblauncher: { display_name: "Barb Launcher", RNG: 24, NB: D6, ATK: 4, STR: 5, AP: 0, DMG: 1, WEAPON_RULES: ["BLAST", "HEAVY"] },
  ...
  chitinous_claws_and_teeth_barbgaunt: { display_name: "Chitinous Claws and Teeth", NB: 1, ATK: 4, STR: 4, AP: 0, DMG: 1, WEAPON_RULES: [] },
  chitinous_claws_and_teeth_neurogaunt: { display_name: "Chitinous Claws and Teeth", NB: 1, ATK: 4, STR: 3, AP: 0, DMG: 1, WEAPON_RULES: [] },
  ...
  leaper_talons: { display_name: "Leaper's Talons", NB: 6, ATK: 3, STR: 5, AP: -1, DMG: 1, WEAPON_RULES: [] },
  monstrous_scything_talons: { display_name: "Monstrous Scything Talons", NB: 6, ATK: 4, STR: 9, AP: -2, DMG: 3, WEAPON_RULES: [] },
  neurotyrant_claws_and_lashers: { display_name: "Neurotyrant Claws and Lashers", NB: 6, ATK: 3, STR: 5, AP: 0, DMG: 1, WEAPON_RULES: [] },
  prime_talons: { display_name: "Prime Talons", NB: 6, ATK: 2, STR: 6, AP: -1, DMG: 2, WEAPON_RULES: [] },
  ...
  talons_and_betencacled_maw: { display_name: "Talons and Betencacled Maw", NB: D6_PLUS_1, ATK: 3, STR: 6, AP: -1, DMG: 2, WEAPON_RULES: ["ANTI_PSYKER:4", "DEVASTATING_WOUNDS"] },
};
...
export function getWeapons(codeNames: string[]): Weapon[] {
  ...
  for (const codeName of codeNames) {
    ...
    if (!weapon) {
      ...
      throw new Error(`Weapon '${codeName}' not found in Tyranid armory. ` + `Available weapons: ${availableWeapons}`);
    }

...
export const TYRANID_ARMORY: Record<string, Weapon> = {
  ...
  barblauncher: {
    ...
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["BLAST", "HEAVY"],
  },
  bio_plasmic_screamer: {
    display_name: "Bio-Plasmic Screamer",
    RNG: 18,
    NB: D6_PLUS_3,
    ATK: 4,
    STR: 8,
  ...
  impaler_cannon: {
    ...
    AP: -1,
    DMG: 1,
    WEAPON_RULES: ["HEAVY", "INDIRECT_FIRE"],
  },
  psychic_scream: {
    ...
    AP: -1,
    DMG: 2,
    WEAPON_RULES: ["IGNORES_COVER", "PSYCHIC", "TORRENT"],
  },
  psychoclastic_torrent: {
    display_name: "Psychoclastic Torrent",
    RNG: 12,
    NB: D6,
    ATK: 1,
    STR: 6,
  ...
  spore_mine_launcher: {
    display_name: "Spore Mine Launcher",
    RNG: 48,
    NB: D3,
    ATK: 4,
    STR: 6,
    AP: -1,
    DMG: 2,
    WEAPON_RULES: ["BLAST", "DEVASTATING_WOUNDS", "HEAVY", "INDIRECT_FIRE"],
  },
  warp_blast_witchfire: {
    display_name: "Warp Blast (Witchfire)",
    RNG: 24,
    NB: D3,
    ATK: 3,
    STR: 7,
    AP: -2,
    DMG: D3,
    WEAPON_RULES: ["BLAST", "PSYCHIC"],
  },
  warp_blast_focused_bolt: {
    display_name: "Warp Blast (Focused Bolt)",
    RNG: 24,
    NB: 1,
    ATK: 3,
    STR: 12,
    AP: -3,
    DMG: D6_PLUS_1,
    WEAPON_RULES: ["LETHAL_HITS", "PSYCHIC"],
  },
  ...
  chitin_barbed_limb: {
    display_name: "Chitin-Barbed Limb",
    NB: 2,
    ATK: 4,
    STR: 5,
    AP: 0,
  ...
  chitinous_claws_and_teeth_barbgaunt: {
    display_name: "Chitinous Claws and Teeth",
    NB: 1,
    ATK: 4,
    STR: 4,
    AP: 0,
  ...
  chitinous_claws_and_teeth_neurogaunt: {
    display_name: "Chitinous Claws and Teeth",
    NB: 1,
    ATK: 4,
    STR: 3,
  ...
  chitinous_claws_and_teeth_ripper_swarm: {
    display_name: "Chitinous Claws and Teeth",
    NB: 6,
    ATK: 5,
    STR: 1,
    AP: 0,
    DMG: 1,
    WEAPON_RULES: ["SUSTAINED_HITS:1"],
  },
  chitinous_claws_and_teeth_zoanthrope: {
    display_name: "Chitinous Claws and Teeth",
    NB: 2,
    ATK: 5,
    STR: 3,
  ...
  chitinous_claws_and_teeth_hive_guard: {
    display_name: "Chitinous Claws and Teeth",
    NB: 3,
    ATK: 4,
    STR: 5,
  ...
  neurotyrant_claws_and_lashers: {
    display_name: "Neurotyrant Claws and Lashers",
    NB: 6,
    ATK: 3,
    STR: 5,
    AP: 0,
  ...
  screamer_killer_talons: {
    display_name: "Screamer-Killer Talons",
    NB: 10,
    ATK: 3,
    STR: 10,
    AP: -2,
  ...
  talons_and_betencacled_maw: {
    display_name: "Talons and Betencacled Maw",
    NB: D6_PLUS_1,
    ATK: 3,
    STR: 6,
    AP: -1,
    DMG: 2,
    WEAPON_RULES: ["ANTI_PSYKER:4", "DEVASTATING_WOUNDS"],
  },
};

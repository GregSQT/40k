...
import { rollD6, calculateWoundTarget, calculateSaveTarget, executeShootingSequence, ShootingResult } from '../../../shared/gameRules';
...
export const useGameActions = ({
  ...
  // Functions imported from shared/gameRules.ts
  //

...
| 2026-08-11 | Métriques réserves et charge, barème, alignement charge 11.02 | 7 tranches, run `x1_long` du même jour — → `Documentation/Implémentation/Implémenté/metriques_reserves_et_charge_2026-08-11.md` |

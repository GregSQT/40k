...
- **`n_steps` n'est pas une égalité** : la config donne le total par mise à jour, PPO reçoit `base // n_envs` ([train.py:883](../ai/train.py#L883)). Le contrôle en tient compte. Ancre `train.py:2862` corrigée le 2026-08-27.

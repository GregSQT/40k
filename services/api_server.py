    ...
    try:
        ...
        if scenario_file:
            ...
            if "terrain_ref" in scenario_data:
                ...
                # pas dessiner leur plateau. La traversée est contrôlée à la résolution, une fois
                # le dossier de données connu (`board_data_dir`).
        ...
        if terrain_ref and terrain_ref.endswith(".json"):
            # Absolu, `..` ou lien symbolique sortant : rejetés d'un seul contrôle sur le chemin résolu.
